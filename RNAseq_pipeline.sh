...
cd /Users/ananya/Desktop/RNASeq_pipeline/
...
java -jar ~/Desktop/tools/Trimmomatic-0.39/trimmomatic-0.39.jar SE -threads 4 data/demo.fastq data/demo_trimmed.fastq TRAILING:10 -phred33
